...
//channel war jaya sathi apan jato /chaiaurcode
//so data body madhun nahi url varun kada lagel
       ...
       const channel= await User.aggregate([
            {
                $match:{
                    username:username?.toLowerCase()//eg chai aur code user che suscriber kiti ahe pahaccha ahe
            ...
            },
            {
                ...
                $lookup:{
                        ...
                        as:"subscribers"
                        //kitne subscibers hai milgaye eg 6000k subscriber milgaye
                 }
            ...
            },
            {
                $addFields:{
                    ...
                    isSubscribed:{
                        $cond:{
                           if:{$in:[req.user?._id,'$subscribers.subscriber']}, //in: present ahe ki nahi donhi pahte array ani object pn
                           then:true,
                           else:false
                        }
                    }
